...
<ul>
<li>Google (Firebase / Google Cloud) — hosting backendu i baza danych; dane przechowywane w regionie Warszawa (europe-central2);</li>
...
<p><strong>Usunięcie konta:</strong> możesz je wykonać samodzielnie w aplikacji, w zakładce
„Konto” → „Usunięcie konta”. Kasujemy wtedy konto, profil firmy i wszystkie dopasowania
przetargów. Dane rozliczeniowe (faktury) przechowujemy przez okres wymagany przepisami
podatkowymi, a dziennik audytu — na podstawie prawnie uzasadnionego interesu (bezpieczeństwo).</p>
<p>Realizacja pozostałych praw: <a href="mailto:${COMPANY.email}">${COMPANY.email}</a>.</p>
